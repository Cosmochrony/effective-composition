...
\title{Independent Effective Subsystems from Non-Injective Admissibility:\\
Support and Preparation Criteria}
...
\begin{document}
  ...
  \begin{abstract}
    ...
    We show that on a non-factorising substrate this assumption splits into two separate, checkable layers,
    and we characterise both exactly in the finite case.
    The arena is a finite configuration set $\Om$ carrying a reference admissible subset, two non-injective
    effective projections $\PiA \colon \Om \to \OA$ and $\PiB \colon \Om \to \OB$, and cylindrical
    admissibility conditions combined by intersection; no factorisation $\Om \simeq \Om_A \times \Om_B$ is
    ...
    non-factorisation alone therefore obstructs nothing.
    ...
    assembly into a necessary support-and-preparation contract for emergent effective subsystems over a
    non-factorising admissibility structure.
    ...
    \emph{Interpretive reading (structural, not a result):} fundamental non-factorisation does not forbid
    independent effective subsystems; it relocates their independence from an inherited property of the
    substrate to an emergent property of the projected support and of the preparation weights.
  \end{abstract}
  ...
  \subsection{The composition gap}
    ...
    The non-injective foundations programme~\cite{Beau2026m,Beau2026ninote} describes observable physics as
    ...
    The substrate of that argument is explicitly non-factorising: no split $\Om \simeq \Om_A \times \Om_B$
    is imposed, and the measurement regions exist only at the level of observable descriptions.
    ...
    If the substrate does not factorise, none of this is given.
    The present paper asks the resulting question in its sharpest finite form:

    \begin{quote}
      On a substrate that does not factorise, equipped with non-injective observable projections, when do
      independently addressable and preparable effective subsystems exist --- and what exactly must be added,
      at the support level and at the preparation level, for independent composition to be possible?
    \end{quote}
  ...
  \subsection{A missing transversal contract}
    ...
    \begin{equation}
      ...
      \text{non-factorising admissibility}
      \;\dashrightarrow\;
      \text{composable effective subsystems}.
    \end{equation}
    The dashed arrow is the open bridge.
  ...
  \subsection{Contributions}
    ...
    \begin{enumerate}
      ...
      Fundamental non-factorisation alone therefore obstructs nothing at this layer.
  ...
  \subsection{What this paper does not claim}
    ...
    No quantum tensor product is derived; no Born rule; no quantum fields; no local tomography.
  ...
  \subsection{Substrate and effective projections}
    ...
    No factorisation $\Om \simeq \Om_A \times \Om_B$ is assumed, and none will be used.
  ...
  \subsection{The simplex-completion benchmark}
    ...
    \begin{corollary}[Non-factorisation alone obstructs nothing]
      \label{cor:noobstruction}
      Once a biclique is available, the non-factorisation of $\Om$ does not by itself obstruct product
      preparations.
  ...
  \label{sec:position}
    ...
    Local tomography is the axiom separating complex quantum theory from its real and quaternionic
    variants, and composite systems are primitive in the framework~\cite{Hardy2001,Barrett2007,
    ...
    preparations exist at all, from projections on a non-factorising substrate, and treats the operational
    composite as the object to be earned rather than assumed.
  ...
  \subsection{Interpretive outlook}
    ...
    a result.
    Fundamental non-factorisation does not forbid independent effective subsystems.
    ...
    What a laboratory calls ``two systems'' is, in this reading, a region of the theory where both layers
